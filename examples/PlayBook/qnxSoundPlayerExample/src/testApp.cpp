...
//--------------------------------------------------------------
void testApp::setup(){
	synth.loadSound("/app/native/sounds/synth.wav");
	beats.loadSound("/app/native/sounds/1085.mp3");
	vocals.loadSound("/app/native/sounds/Violet.mp3");
	synth.setVolume(0.75f);
	beats.setVolume(0.75f);
	vocals.setVolume(0.5f);
	font.loadFont("/app/native/Sudbury_Basin_3D.ttf", 32);
